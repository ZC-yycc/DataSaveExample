...
public class PlayerDebugTool : DebugToolBase
{
    ...
    {
        if(Panel.TryGetVariable(nameof(slot_id_), out object slot_id))
        {
    ...
    {
        if(Panel.TryGetVariable(nameof(slot_id_to_del_), out object slot_id))
        {
    ...
    {
        if(Panel.TryGetVariable(nameof(player_health_), out object increase))
        {
    ...
    public void LevelUp()
    {
        if(Panel.TryGetVariable(nameof(player_level_), out object data))
        {
    ...
    {
        if(Panel.TryGetVariable(nameof(player_name_), out object name))
        {
    ...
    {
        if(Panel.TryGetVariable(nameof(player_id_), out object id))
        {
    ...
    {
        if(Panel.TryGetVariable(nameof(player_score_), out object increase))
        {
